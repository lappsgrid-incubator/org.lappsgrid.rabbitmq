...
/**
 * The QueueManager waits for messages to arrive on its {@link MessageBox MessageBox} and
 * dispatches them to a {@link TaskQueue TaskQueue}.  The TaskQueue is serviced by
